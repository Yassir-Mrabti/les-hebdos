        ...
        <form action="" method="post">
            <table class="table">
                <tr>
                    ...
                    <td>
                        <input required type="password" class="form-control" id="old" name="current_password" placeholder="Mot de passe actuel" required>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input required type="password" class="form-control" id="new" name="new_password" placeholder="Nouveau mot de passe" required>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input required type="password" class="form-control" id="pwd" name="pass_word" placeholder="Confirmer le mot de passe" required>
                    </td>
                </tr>
            </table>
            ...
            if (isset($_POST['submit'])){
                ...
                if ($new_password == $confirmation){
                    ...
                    if ($res == true){
                        ...
                        if ($count == 1){
                            echo 'user exist';
                            $sql1= "Update tbl_user set password='$new_password' where id=$id and password='$current_password'";
